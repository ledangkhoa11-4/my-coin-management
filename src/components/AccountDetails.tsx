      ...
      if (receipt.status === 1) {
        setNetworkResponse({
          ...
          message: (
            <p>
              Transfer complete!{" "}
              <a href={`${mumbai.blockExplorerUrl}/tx/${receipt.transactionHash}`} target="_blank" rel="noreferrer">
                View transaction
              </a>
            </p>
          ),
  ...
  return (
    <div className="">
      ...
      <div className="my-2">
        ...
        <input type="text" value={destinationAddress} onChange={handleDestinationAddressChange} className="border" />
      </div>
      ...
      <div>
        ...
        <input type="number" value={amount} onChange={handleAmountChange} className="border" />
      </div>
